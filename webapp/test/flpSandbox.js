			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"BasicFiori-display": {
								"semanticObject": "BasicFiori",
								"action": "display",
								"description": "Basic Fiori application using Northwind",
								"title": "Basic Fiori",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=basic1.zbasicfiori1",
									"url": sap.ui.require.toUrl("basic1/zbasicfiori1")
								}
							}
						}
					}
